              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center flex-1">
                  <div 
                    className="flex items-center justify-center w-8 h-8 rounded-full mr-2"
                    style={{ 
                      backgroundColor: isLoading ? theme.palette.primary.main : theme.palette.divider,
                      color: isLoading ? theme.palette.primary.contrastText : theme.palette.text.disabled
                    }}
                  >
                    {isLoading ? (
                  ...
                  <span 
                    className="text-sm font-medium"
                    style={{ color: isLoading ? theme.palette.text.primary : theme.palette.text.secondary }}
                  >
                    Generate Drafts
                  </span>
                  <div 
